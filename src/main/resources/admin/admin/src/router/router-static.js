...
import center from '@/views/center'
    ...
    import discusssucaixinxi from '@/views/modules/discusssucaixinxi/list'
    import sucaixinxi from '@/views/modules/sucaixinxi/list'
    import sucaileixing from '@/views/modules/sucaileixing/list'
...
const routes = [{
	...
	path: '/jiaoshi',
      ...
      ,{
	path: '/discusssucaixinxi',
        name: '素材信息评论',
        component: discusssucaixinxi
      }
      ,{
	path: '/sucaixinxi',
        name: '素材信息',
        component: sucaixinxi
      }
      ,{
	path: '/sucaileixing',
        name: '素材类型',
        component: sucaileixing
      }
      ,{
	path: '/config',
        name: '轮播图管理',
